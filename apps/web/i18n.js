(() => {
  ...
  const phrases = {
    ...
    'REVIEWED COLLECTION':'ПОДБОРКА МАТЕРИАЛОВ','29 articles, analyzed and connected':'29 связанных материалов',
    ...
    'Open all 29 reviews →':'Открыть все 29 материалов →','QA AI Lab · Practical knowledge, connected over time.':'QA AI Lab · Практические знания и связи между ними.',
