(() => {
  ...
  const phrases = {
    ...
    'REVIEWED COLLECTION':'ПОДБОРКА МАТЕРИАЛОВ','26 articles, analyzed and connected':'26 связанных материалов',
    ...
    'Open all 26 reviews →':'Открыть все 26 материалов →','QA AI Lab · Practical knowledge, connected over time.':'QA AI Lab · Практические знания и связи между ними.',
