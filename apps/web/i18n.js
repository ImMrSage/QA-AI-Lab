(() => {
  ...
  const phrases = {
    ...
    'REVIEWED COLLECTION':'РАЗОБРАННАЯ ПОДБОРКА','25 articles, analyzed and connected':'25 статей с разборами и связями',
    ...
    'Open all 25 reviews →':'Открыть 25 разборов →','QA AI Lab · Practical knowledge, connected over time.':'QA AI Lab · Практические знания и связи между ними.',
