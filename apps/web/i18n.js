(() => {
  ...
  const phrases = {
    ...
    'REVIEWED COLLECTION':'РАЗОБРАННАЯ ПОДБОРКА','23 articles, analyzed and connected':'23 статьи с разборами и связями',
    ...
    'Open all 23 reviews →':'Открыть 23 разбора →','QA AI Lab · Practical knowledge, connected over time.':'QA AI Lab · Практические знания и связи между ними.',
