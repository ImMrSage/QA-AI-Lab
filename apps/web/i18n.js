(() => {
  ...
  const phrases = {
    ...
    'REVIEWED COLLECTION':'ПОДБОРКА МАТЕРИАЛОВ','27 articles, analyzed and connected':'27 связанных материалов',
    'Explore practical QA guidance, examples and diagrams in the connected knowledge library.':'Практические материалы по QA, примеры и схемы в связанной библиотеке знаний.',
    'Open all 27 reviews →':'Открыть все 27 материалов →','QA AI Lab · Practical knowledge, connected over time.':'QA AI Lab · Практические знания и связи между ними.',
