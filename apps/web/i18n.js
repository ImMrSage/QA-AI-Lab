(() => {
  ...
  const phrases = {
    ...
    'REVIEWED COLLECTION':'ПОДБОРКА МАТЕРИАЛОВ','31 articles, analyzed and connected':'31 связанный материал',
    ...
    'Open all 31 reviews →':'Открыть все 31 материал →','QA AI Lab · Practical knowledge, connected over time.':'QA AI Lab · Практические знания и связи между ними.',
