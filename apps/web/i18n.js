(() => {
  ...
  const phrases = {
    ...
    'REVIEWED COLLECTION':'ПОДБОРКА МАТЕРИАЛОВ','34 articles, analyzed and connected':'34 связанных материала',
    ...
    'Open all 34 reviews →':'Открыть все 34 материала →','QA AI Lab · Practical knowledge, connected over time.':'QA AI Lab · Практические знания и связи между ними.',
