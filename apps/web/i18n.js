(() => {
  ...
  const phrases = {
    ...
    'REVIEWED COLLECTION':'ПОДБОРКА МАТЕРИАЛОВ','30 articles, analyzed and connected':'30 связанных материалов',
    ...
    'Open all 30 reviews →':'Открыть все 30 материалов →','QA AI Lab · Practical knowledge, connected over time.':'QA AI Lab · Практические знания и связи между ними.',
