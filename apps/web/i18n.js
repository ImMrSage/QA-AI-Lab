(() => {
  ...
  const phrases = {
    ...
    'REVIEWED COLLECTION':'РАЗОБРАННАЯ ПОДБОРКА','20 articles, analyzed and connected':'20 статей с разборами и связями',
    ...
    'Open all 20 reviews →':'Открыть 20 разборов →','QA AI Lab · Practical knowledge, connected over time.':'QA AI Lab · Практические знания и связи между ними.',
