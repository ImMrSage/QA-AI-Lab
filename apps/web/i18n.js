(() => {
  ...
  const phrases = {
    ...
    'REVIEWED COLLECTION':'ПОДБОРКА МАТЕРИАЛОВ','28 articles, analyzed and connected':'28 связанных материалов',
    ...
    'Open all 28 reviews →':'Открыть все 28 материалов →','QA AI Lab · Practical knowledge, connected over time.':'QA AI Lab · Практические знания и связи между ними.',
