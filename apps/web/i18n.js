(() => {
  ...
  const phrases = {
    ...
    'REVIEWED COLLECTION':'РАЗОБРАННАЯ ПОДБОРКА','22 articles, analyzed and connected':'22 статьи с разборами и связями',
    ...
    'Open all 22 reviews →':'Открыть 22 разбора →','QA AI Lab · Practical knowledge, connected over time.':'QA AI Lab · Практические знания и связи между ними.',
