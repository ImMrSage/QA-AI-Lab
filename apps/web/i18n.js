(() => {
  ...
  const phrases = {
    ...
    'REVIEWED COLLECTION':'ПОДБОРКА МАТЕРИАЛОВ','32 articles, analyzed and connected':'32 связанных материала',
    ...
    'Open all 32 reviews →':'Открыть все 32 материала →','QA AI Lab · Practical knowledge, connected over time.':'QA AI Lab · Практические знания и связи между ними.',
