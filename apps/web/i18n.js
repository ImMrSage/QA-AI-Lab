(() => {
  ...
  const phrases = {
    ...
    'REVIEWED COLLECTION':'РАЗОБРАННАЯ ПОДБОРКА','24 articles, analyzed and connected':'24 статьи с разборами и связями',
    ...
    'Open all 24 reviews →':'Открыть 24 разбора →','QA AI Lab · Practical knowledge, connected over time.':'QA AI Lab · Практические знания и связи между ними.',
