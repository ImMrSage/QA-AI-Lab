(() => {
  ...
  const phrases = {
    ...
    'REVIEWED COLLECTION':'ПОДБОРКА МАТЕРИАЛОВ','33 articles, analyzed and connected':'33 связанных материала',
    ...
    'Open all 33 reviews →':'Открыть все 33 материала →','QA AI Lab · Practical knowledge, connected over time.':'QA AI Lab · Практические знания и связи между ними.',
