(() => {
  ...
  const phrases = {
    ...
    'REVIEWED COLLECTION':'РАЗОБРАННАЯ ПОДБОРКА','21 articles, analyzed and connected':'21 статья с разборами и связями',
    ...
    'Open all 21 reviews →':'Открыть 21 разбор →','QA AI Lab · Practical knowledge, connected over time.':'QA AI Lab · Практические знания и связи между ними.',
