...
- [API foundations: two-part review](qa/api-testing/api-foundations-and-http-pitfalls.md) — QA4Life architecture and HTTP guide, with corrections and a practice matrix.
...
- [Automation](qa/automation/README.md) — Playwright, TypeScript, fixtures, test isolation, test data, and flaky tests.
...
- [Agents](ai/agents/README.md) — agent workflows and their practical QA applications.
...
- [CI/CD](tools/ci-cd/) — test execution, pipelines, reporting, and quality gates.
- [Monitoring](tools/monitoring/README.md) — observability and production investigation.
- [Productivity](tools/productivity/) — utilities that improve everyday QA workflows.
...
[Glossary](glossary/) — concise definitions linked to deeper topic notes.
...
- [Product and repository architecture](docs/architecture.md)
