...
Разделяйте, где проводится тестирование, что оценивается, зачем выполняется проверка и как она выполняется. Это разные измерения, а не взаимоисключающие названия.
...
## Разбор источника QA4Life

Статья группирует тестирование по уровням, назначению, сценариям и характеристикам качества, затем предлагает выбирать проверки по изменениям на примерах лояльности, почты и платежей. Её практическая ценность — вопросы о рисках. Численные нагрузки, целевое время ответа и история инцидента — примеры автора, а не независимо проверенные ориентиры или универсальные требования.

Дополнительные уточнения: отказ в доступе к объекту не всегда должен возвращать 403; проверяйте описанное правило доступа и отсутствие утечки данных. Внешний вид UI и удобство использования — разные вопросы. Доступность шире одного значения контраста. Для текста обычного размера приведённая техника WCAG рассматривает минимум 4.5:1; другие размеры текста и компоненты оценивайте по применимым критериям. См. [W3C, техника контраста G18](https://www.w3.org/WAI/WCAG22/Techniques/general/G18.html).

Охват: все семь текстовых разделов прочитаны 2026-09-12. Сценарии приложения не выполнялись, инцидент из источника независимо не воспроизводился.

- [QA4Life / Евгений Гусинец — Виды и типы тестирования](https://telegra.ph/Vidy-i-tipy-testirovaniya--shpargalka-QA-07-03-2)

## Связанные темы и ранние источники
