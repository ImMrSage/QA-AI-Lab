...
Используйте терминологию ML для критического чтения оценок, а не только узнавания названий алгоритмов. Модель может иметь высокую accuracy, пропуская важные сбои. Оценивайте вместе разбиение данных, порог решения, типы ошибок и реальный результат задачи.

Это QA-ориентированное изложение четырёх глав [ML Glossary](https://ml-cheatsheet.readthedocs.io/en/latest/), а не обзор всего сайта. См. [охват и исправления](../../docs/sources/ml-cheatsheet-review.md).
