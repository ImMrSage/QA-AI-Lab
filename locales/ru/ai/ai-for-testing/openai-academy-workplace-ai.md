...
Учебный ресурс для оценки практического внедрения AI в QA-команде. Это анонс курсов, а не техническое руководство тестирования или доказательство улучшения QA-результатов.

## Что говорит источник

12 июня 2026 года OpenAI анонсировала три курса Academy:

| Курс | Заявленный фокус |
| --- | --- |
| AI Foundations | Промпты, контекст, проверка результатов и ответственное использование в повседневных задачах |
| Applied AI Foundations | Повторяемые процессы с входами, моделями, инструментами, контрольными точками и проверкой человеком; компромиссы качества, скорости и стоимости |
| Agents and Workflows | Управление задачами с агентами через контекст, результаты, границы и ревью |

Анонс описывает сертификаты завершения и организационное обучение. Он не устанавливает длительность, стоимость, требования, языки или право этого пользователя записаться. Эти детали не проверены. Ни один курс для заметки не проходился и независимо не оценивался. [Исходный анонс](https://openai.com/index/academy-courses-applying-ai-at-work/)
